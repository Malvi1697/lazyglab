...
// hint names the direction the key goes, so it never offers to hide something that is
// already hidden.
...
// splitBody stacks a list above a box, with a blank row between them so the two halves
// do not run together.
