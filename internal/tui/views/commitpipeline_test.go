...
func TestCommitRows_ShowAuthorNotHash(t *testing.T) {
	...
	row := commitItemRow(v.visible()[0], commitLayout{kind: 6, subject: 60, updated: 11}, 120)
...
func TestOverviewRows_ShowAuthorNotHash(t *testing.T) {
	...
	row := v.commitRow(v.visible()[0], commitLayout{kind: 6, subject: 60, updated: 11}, 120)
...
func TestCommitRows_LongAuthorIsTruncatedForAlignment(t *testing.T) {
	...
	visible := v.visible()
	rows := []string{commitItemRow(visible[0], commitLayout{kind: 6, subject: 60, updated: 11}, 120), commitItemRow(visible[1], commitLayout{kind: 6, subject: 60, updated: 11}, 120)}
